...
Original use of these programs was to compare the galsim simulations generated by generate_simulation_psf.py to the theoretical PSFs generated by generate_theory_psf.py. Specifically, comparison was made between the full width half maximum (FWHM) of the theoretical profiles and averaged profiles derived from the galsim-generated images. Details can be found in the presentation linked below. 
